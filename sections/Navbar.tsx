        ...
        <div className="flex-1 flex gap-3 items-center">
          <div className="">
            ...
            <Image
              ...
              width={56}
              height={56}
              className={cn("w-14 h-14", isDark && "invert")}
            />
          </div>
          <Link
            className="transition text-sm lg:text-lg duration-300 font-semibold hover:text-primary-800"
            href="/#main"
          >
            {t("title")}
          </Link>
        ...
        {isOpen && (
          ...
          >
            {navbarLink.map((link, idx) => (
              <div
                key={idx}
                className="pl-5 py-3 flex justify-center hover:text-primary-900"
              >
                <Link
